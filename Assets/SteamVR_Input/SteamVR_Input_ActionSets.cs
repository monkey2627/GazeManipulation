...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_baseline p_baseline;
        ...
        public static SteamVR_Input_ActionSet_baseline baseline
        {
            get
            {
                return SteamVR_Actions.p_baseline.GetCopy<SteamVR_Input_ActionSet_baseline>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_baseline = ((SteamVR_Input_ActionSet_baseline)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_baseline>("/actions/baseline")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.baseline};
        }
    }
}
